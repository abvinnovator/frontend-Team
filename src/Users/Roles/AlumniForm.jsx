    ...
    <div className="flex flex-col font-semibold text-gray-900 p-10 md:p-20 max-w-lg mx-auto bg-white rounded-lg shadow-xl">
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
        >
          Sign Up
        </button>
      </form>
